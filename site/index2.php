                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 form-line">
                                        <div class="form-submit">
                                            <input value="Fluent" class="btn btn-common" id="form-submit" onclick="question1()"><i
                                    ...
                                    <div class="col-md-12 form-line">
                                        <div class="form-submit">
                                            <input value="Conversational"  class="btn btn-common" id="form-submit" onclick="question1()"><i
                                                    class="fa fa-paper-plane" aria-hidden="true"></i>
                                            <div id="msgSubmit" class="h3 text-center hidden"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 form-line">
                                        <div class="form-submit">
                                            <input value="Only Native Language"   class="btn btn-common" id="form-submit" onclick="question1()"><i
                                                    class="fa fa-paper-plane" aria-hidden="true"></i>
                                            <div id="msgSubmit" class="h3 text-center hidden"></div>
                                        </div>
                                    </div>
                        ...
                        <div class="form-wrapper">
                            <form role="form" method="post" id="contactForm" name="contact-form"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 form-line">
                                        <div class="form-submit">
                                            <input value="Single"  class="btn btn-common" id="form-submit" onclick="question2()"><i
                                                    class="fa fa-paper-plane" aria-hidden="true"></i>
                                            <div id="msgSubmit" class="h3 text-center hidden"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 form-line">
                                        <div class="form-submit">
                                            <input value="Married" class="btn btn-common" id="form-submit" onclick="question2()"><i
                                                    class="fa fa-paper-plane" aria-hidden="true"></i> 
                                            <div id="msgSubmit" class="h3 text-center hidden"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 form-line">
                                        <div class="form-submit">
                                            <input value="Divorced" class="btn btn-common" id="form-submit" onclick="question2()"><i
                                                    class="fa fa-paper-plane" aria-hidden="true"></i>
                                            <div id="msgSubmit" class="h3 text-center hidden"></div>
                                        </div>
                                    </div>
                        ...
                        <div class="form-wrapper">
                            <form role="form" method="post" id="contactForm" name="contact-form"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 form-line">
                                        <div class="form-submit">
                                            <input value="Student" class="btn btn-common" onclick="question3()" id="form-submit"><i
                                                    class="fa fa-paper-plane" aria-hidden="true"></i> 
                                            <div id="msgSubmit" class="h3 text-center hidden"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 form-line">
                                        <div class="form-submit">
                                            <input value="Employeed" class="btn btn-common" id="form-submit" onclick="question3()"><i
                                                    class="fa fa-paper-plane" aria-hidden="true"></i>
                                            <div id="msgSubmit" class="h3 text-center hidden"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 form-line">
                                        <div class="form-submit">
                                            <input value="Unemployeed" class="btn btn-common" onclick="question3()" id="form-submit"><i
                                                    class="fa fa-paper-plane" aria-hidden="true"></i>
                                            <div id="msgSubmit" class="h3 text-center hidden"></div>
                                        </div>
                                    </div>
    ...
    <section id="contact-map4" class="section-padding" style="display: none;">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title-header text-center">
                        <h2 class="section-title wow fadeInUp" data-wow-delay="0.2s">Resident Card Lottery - Online Registration:
                        </h2>
                        <p style="font-weight: bold;">After Checking Your Answers And Put It Into Consideration, You Have Qualified For A Chance To Win The Sweedish Resident Card. Complete The Below Steps To Obtain The "Sweedish Resident Card Lottery" Form</p>
                        <p>You may get the Sweedish Resident Card Lottery Form" with only one step, kindly click the "SHARE TO CONTINUE" button below to share this information with 5 friends on WhatsApp so That They Can Aslo Benefit.
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="form-wrapper">
                            <!-- <form role="form" method="post" id="contactForm" name="contact-form"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 form-line text-center mb-3">
                                        <!-- <div class="form-submit"> -->
                                            After sharing to WhatsApp Group, click the "Resident Card Form" button to proceed:
                                        <!-- </div> -->
                                    </div>
                                    ...
                                    <div class="col-md-12 form-line text-center mb-3">
                                        <div class="form-submit">
                                            <a onclick="" class="btn btn-common" id="web1"><i
                                                    class="fa fa-paper-plane" aria-hidden="true"></i> Green Card Form </a>
                                            <div id="msgSubmit" class="h3 text-center hidden"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 form-line text-center" style="color: red;">
                                        <!-- <div class="form-submit"> -->
                                            Note: If you do not complete this step correctly, you will not Get US Green Card Registration Form.
                                        <!-- </div> -->
                                    </div>
